            ...
            WidgetContainer(
              child: Column(
                ...
                children: [
                  ...
                  Text("Letzter Nutzer: ${computer.lastUser}"),
                  const SizedBox(height: App.smallPadding),
                  Text("Zuletzt verwendet: ${computer.lastSeen.day}-${computer.lastSeen.month}-${computer.lastSeen.year}"),
                  const SizedBox(height: App.smallPadding),
                  Text("IP: ${computer.ipAddress}"),
                  const SizedBox(height: App.smallPadding),
                  Text("MAC: ${computer.macAddress}"),
                ],
              ),
            ),
            const SizedBox(height: App.defaultPadding),
